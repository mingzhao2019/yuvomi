export const schemas = {
        ...
        NotificationChannel: {
          type: 'object',
          description: 'A Gotify, ntfy, generic Webhook, message-pusher, or email notification channel. Household channels are visible to administrators; personal channels are visible only to their owner. Secrets are write-only and never returned.',
          properties: {
            id: { type: 'integer' },
            provider: { type: 'string', enum: ['gotify', 'ntfy', 'webhook', 'message_pusher', 'email'] },
            name: { type: 'string' },
            ...
            config: { type: 'object', additionalProperties: true, description: 'Provider settings. Email uses toAddress; Webhook supports payloadTemplate; message_pusher supports messageTemplate. Both templates use the documented notification placeholders.' },
        ...
        NotificationChannelInput: {
          ...
          properties: {
            ...
            config: {
              type: 'object',
              description: 'Provider config. Email uses toAddress. Webhook uses baseUrl and optional payloadTemplate. message_pusher uses baseUrl, username, method, postFormat, messageField, optional messageTemplate, channel, and tokenInQuery. Templates support title, body, description, details, entity/date/time, reminder, delivery, navigation, and status fields.',
