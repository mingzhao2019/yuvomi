...
const MIGRATIONS_SQL = {
  ...
  `,
  // SQL-String für Migration v180 (gespiegelt aus db.js MIGRATIONS):
  // Die upstream v174 ist im custom Schema bereits für To Do belegt; die
  // Capability-Rebuild-Operation wird deshalb append-only als v180 ausgeführt.
  180: `
  ...
  `,
  // SQL-String für Migration v186 (gespiegelt aus db.js MIGRATIONS):
  ...
  206: `
      ...
      END;
    `,
  // Migration 207: only the one table test-search.js needs (waste_types) -
  ...
  `,
  // Migration 216: FTS triggers + backfill for waste_types, same shape as key 66.
  216: `
  ...
  `,
  // Nur die Markierungstabelle aus v225, nicht der ganze Eintrag: sie ist die,
