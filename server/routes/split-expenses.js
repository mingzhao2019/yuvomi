...
//
// Migration v235 baut verlorene Zeilen mit einer EINGEFRORENEN SQL-Fassung
// dieser Regel neu auf. Aendert sich die Regel, wird test:split-ledger-rebuild-
// migration rot - dann gilt die neue Regel ab hier, v235 bleibt, wie sie ist.
...
router.get('/groups/:id/activity', (req, res) => {
  try {
    ...
    const rows = fetched.slice(0, limit).map((row) => {
      ...
      // 'ledger_restored' (Migration v235) speichert den Betrag in Minor-Units:
