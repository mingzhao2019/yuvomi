...
export const TOGGLEABLE_MODULES = [
  'tasks', 'calendar', 'meals', 'recipes', 'shopping', 'pantry', 'inventory', 'asset-cost',
  'birthdays', 'notes', 'contacts', 'budget', 'documents',
  'housekeeping', 'waste', 'rewards', 'health', 'schedule',
];
const MODULE_ORDER_RE = /^(dashboard|tasks|calendar|meals|recipes|shopping|pantry|inventory|asset-cost|birthdays|notes|contacts|budget|documents|housekeeping|waste|rewards|health|schedule|third-party-[a-z0-9][a-z0-9-]{1,62}[a-z0-9])$/;
const MOBILE_NAV_ORDER_RE = /^(tasks|calendar|kitchen|meals|recipes|shopping|pantry|inventory|asset-cost|birthdays|notes|contacts|budget|documents|housekeeping|waste|rewards|health|schedule|third-party-[a-z0-9][a-z0-9-]{1,62}[a-z0-9])$/;
