...
// er im Kalender liegt. Er hinterlässt aber eine Spur, die kein Import trägt -
...
// target_google_calendar_id nicht nachgetragen. Solche Termine sehen deshalb
// wie Importe aus. Google-Termine, die vor dem Einspielen von Migration 47
// angelegt wurden, bleiben deshalb ganz aussen vor - ein alter Import wird
// dabei mitgenommen, aber uebersprungen ist die sichere Richtung. Die Tabellen-
 ...
 * nichts mehr.
 *
 * NUR DIE BESTÄTIGTE LISTE. Zwischen den Happen laufen andere Anfragen, auch
 * ein Sync oder eine Zuweisung von Hand. Die Liste ist deshalb die bei der
 * Bestätigung gezählte, und jede Zeile wird beim Schreiben erneut geprüft:
 * ist der Termin inzwischen zugewiesen oder zeigt sein Kalender auf eine
 * andere Person, bleibt er stehen; ein inzwischen neu hinzugekommener Kandidat
 * wird nicht angefasst. Die Rückgabe zählt nur, was tatsächlich zugewiesen
 * wurde.
 *
 * IN HAPPEN, NICHT IN EINER TRANSAKTION. Ein Haushalt mit Jahren an
 * iCloud-Historie hat Tausende Termine; jeder Happen ist eine eigene Transaktion
 * (50 Termine), dazwischen kommen andere Anfragen dran. Bricht der Lauf ab,
 * setzt ein zweiter dort fort.
 *
 ...
 * Termine haben keins von beidem, für sie reichen zwei Schreibzugriffe.
 *
 ...
 * künftige kommen wie gewohnt. Ein Termin, dessen Anleger nur vergangene
