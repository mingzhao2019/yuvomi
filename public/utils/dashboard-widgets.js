 ...
 * ein Fehler auffällt. */
export const WIDGET_IDS = ['tasks', 'calendar', 'meals', 'shopping', 'assets', 'birthdays', 'countdown', 'budget', 'rewards', 'health', 'cycle', 'housekeeping', 'schedule', 'waste', 'family', 'notes', 'weather', 'clock', 'metrics', 'quicklinks'];
