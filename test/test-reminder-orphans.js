/**
 * Modul: Verwaiste Erinnerungen (Migration v227)
 ...
 *        hat die Erinnerung einer geloeschten Aufgabe bis v227 allein der
 ...
 *          2. das einmalige Abraeumen der Bestands-Waisen in v227 selbst;
...
// erzeugen, die es nach v227 gar nicht mehr geben kann.
// --------------------------------------------------------
...
// --------------------------------------------------------
// 2. Das einmalige Abräumen in v227 selbst
// --------------------------------------------------------

test('v227 raeumt die Waisen ab, die vor ihr entstanden sind', () => {
  // Stand VOR v227: die Trigger gibt es noch nicht, eine gelöschte Aufgabe
  // lässt ihre Erinnerung also wirklich stehen - so ist der Bestand entstanden,
  // den die Migration vorfindet.
  const old = buildTestDb({ upTo: 226 });
  ...
  const v227 = MIGRATIONS.find((m) => m.version === 227);
  assert.ok(v227, 'Migration v227 fehlt');
  old.exec(v227.up);
