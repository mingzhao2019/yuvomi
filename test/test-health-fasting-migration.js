...
const migration = MIGRATIONS.find((item) => item.version === 219);
...
test('v219 creates fasting records and sparse settings', () => {
...
test('v219 enforces one active fast, note/rating/goal bounds and audit FK actions', () => {
  const database = migrated();
