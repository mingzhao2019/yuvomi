...
// ========================================================
// ZYKLUS v2: Zervixschleim/Tests/Intimacy, Mehrfach-Gefühle (Migrationen 220-221)
// ========================================================
...
test('Cycle-Log: neue Skalarfelder + feelings im Round-Trip', async () => {
  ...
  // Die mood-Spalte wird seit Migration 221 nie mehr beschrieben, auch nicht,
...
// mitschickt (z. B. nur `flow` aendert), darf einen schon vor Migration 221
...
// Migration 221 (oder ein alter Client) getragen haette - die API selbst
