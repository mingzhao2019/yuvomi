/**
 * Test: Laufnummern der Einkaufslisten (Migration v206, GET /shopping/versions)
 ...
 *        Dazu der Backfill der Migration gegen eine Vor-v206-Datenbank.
...
// --------------------------------------------------------------------------
test('v206: bestehende Listen bekommen beim Update ihre Zeile mit 0', () => {
  const V = MIGRATIONS.find((m) => m.version === 206);
  assert.ok(V, 'Migration v206 vorhanden');
