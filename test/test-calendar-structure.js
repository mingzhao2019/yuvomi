 ...
 * muss dieselbe {Methode, Pfad}-Routentabelle wie vor dem Split ergeben (71
...
const EXPECTED = [
  ...
  'PUT /outlook/accounts/:id/selections',
  'POST /outlook/sync',
  'POST /outlook/todo/sync',
  'GET /outlook/status',
  'GET /outlook/todo/status',
];

test('Orchestrator ergibt exakt die erwartete Routentabelle (71 Routen)', () => {
